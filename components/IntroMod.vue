<template>
 ...
 <label class="pure-material-checkbox">
           <input id="checkbox" v-model="checkbox" name="checkbox" type="checkbox">
            <span>Checkbox</span>
           </label>
    ...
    <div class="first-container" :style="bgStyle">
      <div class="info-container">
        <div>
          <img class="icon" />
          <h3>Address</h3>
          <p>, 379 Hudson St, New York, NY 10018 US</p>
        </div>
        <div>
          <img class="icon" />
          <h3>Lets Talk</h3>
...
import SubSucces from '@/components/SubSucces.vue';

export default {
  components: { MaterialInput, MaterialSelect, MaterialTextarea, SubSucces },
  props: {
checkbox:{
      type: Boolean,
      default: null,
  ...
  methods: {
    ...
    handleSubmit() {
      fetch("/", {
        ...
        .then(() => this.$router.push("index.vue")).catch(error => alert(error))
