      ...
      <div class="hero">
        <div class="topsection">
          <div style="" class="main-logo">
            <img
              class="prodLogo"
              src="@/static/images/buge-font.png"
              alt=""
            />
          </div>
          <div class="tagline">
      ...
      <div class="link-section row">
        ...
        <div class="tooltipin">
          <b-tooltip
            ...
            triggers="hover"
          >
            Bug-E is fully electric to support you whenever you need it. Combine your power with technology and leave others behind.
          </b-tooltip>
          <b-tooltip
            ...
            triggers="hover"
          >
            1With the top speed of [X], you can now overtake everybody else the same way Bug-E overtook the competition.
          </b-tooltip>
          <b-tooltip
            ...
            triggers="hover"
          >
            Say goodbye to rain with a fully covered case. Everywhere you go, in any weather, we have got you covered – literally!
          </b-tooltip>
          <b-tooltip
            ...
            triggers="hover"
          >
           With a bike like Bug-E, you simply can’t enjoy it all by yourself. With an extra seat, you can now take anybody on this journey with you.
          </b-tooltip>
        </div>
      </div>
    </div>
   <div class="section2">
      <div class="truck-area even-col">
        ...
        <p class="description-text">
          ...
          <br> With enough
          space and load capacity to move everything you need, this little <span class="text-deco">  <strong>StrongBike</strong> </span> will
          help you with some of the heaviest tasks, again and again, with other
          people looking at you in awe, wondering how smoothly you’re moving.
        </p>
      </div>
